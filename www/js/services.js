  ...
  return {
    ...
    getMarkers: function(tags){
      ...
      return _db.query(function(doc, emit) {
        console.log('ddd');
        console.log(tags);
      console.log(doc.category === 'points' && doc.text == tags);
        if (doc.category === 'points' && check_marks(doc.tags,tags) === true) {
          console.log('text1');
          emit(doc.text);
        }
        else if (doc.category === 'points' && tags === undefined) {
          emit(doc.text);
            console.log('text2');
        }
...
$rootScope, $cordovaNetwork,$stateParams, ConnectivityMonitor,$http,Jeeps,$timeout,$ionicPopup,$translate){
  ...
  function initMap(){
      ...
      google.maps.event.addListenerOnce(map, 'idle', function(){
        ...
        if (latlng2 !==undefined || ctr1==='1ride') {
        ...
        console.log('lege');
        console.log($translate('tab1_title'));
